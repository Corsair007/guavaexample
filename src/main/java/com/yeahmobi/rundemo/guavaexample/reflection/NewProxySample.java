...
/**
 * @rundemo_name 动态代理
 * @desc Reflection.newProxy(Class,
 *       InvocationHandler)是一种更安全，更方便的API，它只有一个单一的接口类型需要被代理来创建Java动态代理时
 * @author root
 *
 */
public class NewProxySample {
	...
	public static void main(String[] args) {
		...
		// Guava提供的方式：
		Subject subject1 = Reflection.newProxy(Subject.class, handler);
		subject1.rent();
	}
